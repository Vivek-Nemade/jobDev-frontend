...
export function Input({ label, error,type, className = "", ...props }) {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <input type={inputType} className={`w-full border rounded-lg px-3 py-2 text-sm outline-none focus:ring-2 
                                          focus:ring-primary-500 focus:border-transparent ${isPassword ? "pr-10" : ""}
                                          ${error ?"border-red-300" :"border-gray-300"} ${className}`} {...props}
