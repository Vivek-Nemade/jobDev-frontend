      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">
            Sign in to your TalentForge account
          </p>
        </div>
        ...
        <Card>
          ...
          <div className="border border-gray-200 rounded-lg px-4 py-3 bg-gray-50">
            <h1 className="text-sm font-semibold text-gray-800 mb-2">
              Please use our instant Demo credentials, or use Google login
              instead
            </h1>
            <div className="flex flex-col gap-1.5">
              <p className="text-xs text-gray-600">
                <span className="font-medium text-gray-800">Recruiter:</span>{" "}
                demo@recruiter.com&nbsp;/&nbsp;demo123456
              </p>
              <p className="text-xs text-gray-600">
                <span className="font-medium text-gray-800">Jobseeker:</span>{" "}
                demo@jobseeker.com&nbsp;/&nbsp;demo123456
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <Link
                to="/forgot-password"
                className="text-xs text-primary-600 hover:underline mt-1 block text-right"
              >
                Forgot password?
              </Link>
            </div>
